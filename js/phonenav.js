  ...
  if($(this).children(".div1").is(":hidden")){
    ...
    if(!$(this).children(".div1").is(":animated")) {
      ...
      if(myBrowser()=="IE"){
        ...
        $(this).children(".xiala").css({'filter':'progid:DXImageTransform.Microsoft.BasicImage(rotation:1)'});
      	...
      	// $(this).children(".xiala").css({'transform':'rotate(45deg)'});  
        $(this).children(".xiala").css({'display':'none'});
        $(this).children(".xiala2").css({'display':'block'});
      }
      //如果当前没有进行动画，则添加新动画
    ...
    if(!$(this).children(".div1").is(":animated")) {
      ...
      if(myBrowser()=="IE"){
        ...
        $(this).children(".xiala2").css({'display':'none'});
      }
...
$(".menu_list ul li .div1 .zcd").click(function() {
  ...
  $(".lis>.fuMenu").click(function() {
    ...
    if(!$(this).is(":hidden")){
      ...
      if(myBrowser()=="IE"){
        ...
        $(this).parent().children(".xiala").css({'display':'block'});
      }
    }
    });
  });
 ...
 //循环所有div1元素，下拉箭头在
  ...
  $("#hidIcon").click(function(){
    //隐藏菜单并显示隐藏后的左侧菜单
    $(".leftMenu").animate({"left":"-220px"},"slow",function(){
